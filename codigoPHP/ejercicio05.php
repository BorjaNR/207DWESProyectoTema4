    ...
    <body>
        ...
        <main style="margin-bottom: 75px" class="fs-5 text-center">
            ...
            try {
                ...
                $consultaPreparada1 = $miDB->prepare("INSERT IGNORE INTO T02_Departamento(T02_CodDepartamento, T02_DescDepartamento, T02_FechaCreacionDepartamento, T02_VolumenDeNegocio, T02_FechaBajaDepartamento) VALUES ('AAG', 'Departamento de Cobro', now(), 300, NULL)");
                $consultaPreparada2 = $miDB->prepare("INSERT IGNORE INTO T02_Departamento(T02_CodDepartamento, T02_DescDepartamento, T02_FechaCreacionDepartamento, T02_VolumenDeNegocio, T02_FechaBajaDepartamento) VALUES ('AAE', 'Departamento de Quejas', now(), 10000, NULL)");
                $consultaPreparada3 = $miDB->prepare("INSERT IGNORE INTO T02_Departamento(T02_CodDepartamento, T02_DescDepartamento, T02_FechaCreacionDepartamento, T02_VolumenDeNegocio, T02_FechaBajaDepartamento) VALUES ('AAF', 'Departamento de Inmuebles', now(), 30, NULL)");
                ...
                if ($consultaPreparada1->execute() && $consultaPreparada2->execute() && $consultaPreparada3->execute()) {
